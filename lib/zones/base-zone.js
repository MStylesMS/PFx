...
class BaseZone {
    ...
    async _stopBackgroundWithFade(fadeTime, { resetState, eventPayload, onFadeComplete }) {
    ...
    async _playBackgroundWithLifecycle(audioPath, params = {}, {
        ...
        applySuccessState({ audioPath, targetVolume, resolved });

        if (typeof applyTelemetry === 'function') {
            applyTelemetry({ audioPath, targetVolume, resolved });
        }
        ...
        if (typeof onSuccess === 'function') {
            onSuccess({ audioPath, targetVolume, resolved, shouldLoop, commandPayload });
        }
