...
class AudioManager {
    ...
    async playBackgroundMusic(filePath, volume = null, loop = false, options = {}) {
        ...
        this.logger.info(`Playing background music: ${filePath} at volume ${targetVolume} (loop: ${loop}, id: ${id})`);
        ...
        try {
            ...
            await this._loadBackgroundOnBed(bed, filePath, targetVolume, !!loop, { displayFile });
