...
const LightZone = require('../zones/light-zone');
const InputZone = require('../zones/input-zone');
...
class ZoneManager {
    ...
    async _createZone(zoneName, zoneConfig) {
        ...
        switch (zoneConfig.type) {
            ...
            case 'light':
            case 'light_group':
                zone = new LightZone(mergedConfig, this.mqttClient, this);
                break;
            case 'input':
                zone = new InputZone(mergedConfig, this.mqttClient, this);
                break;
            default:
    ...
    async _handleZoneCommand(zoneName, zone, message) {
        ...
        try {
            ...
            const mediaPath = command.file || command.audio || command.video || command.image;
            ...
            try {
                ...
                if (commandName === 'playSpeech') {
                    if (command.file) {
                        ...
                        eventPayload.file = command.audio;
                    }
